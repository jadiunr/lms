...
@section('content')
    <div class="row">
        <div class="col-lg-6" style="position: relative">
            <p>正答数　<span style="font-size: 90px;color: @if($correct_count<=80 and $correct_count>=64)#CEF6CE @elseif($correct_count<64 and $correct_count>=48)#FFCA00 @elseif($correct_count<40)#F6CECE @endif">{{$correct_count}}</span>/80</p>
            ...
            @else
                <div class="result_image" style="margin-left:150px;font-size:100px;color:red;display: none">
                    不合格
                </div>
            @endif
        </div>
