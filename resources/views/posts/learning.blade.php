                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="select-list">
                            <li><a href='{{url('/exam/learning/answer?id='.$problem_id->id,'ア')}}' class="select-btn"><button>ア</button></a><span>{{$problem_id->answer1}}</span></li>
                            <li><a href='{{url('/exam/learning/answer?id='.$problem_id->id,'イ')}}' class="select-btn"><button>イ</button></a><span>{{$problem_id->answer2}}</span></li>
                            <li><a href='{{url('/exam/learning/answer?id='.$problem_id->id,'ウ')}}' class="select-btn"><button>ウ</button></a><span>{{$problem_id->answer3}}</span></li>
                            <li><a href='{{url('/exam/learning/answer?id='.$problem_id->id,'エ')}}' class="select-btn"><button>エ</button></a><span>{{$problem_id->answer4}}</span></li>
                        </ul>
                        @endif
                    </div>
            ...
            <div class="col-lg-3" style="margin-top: 100px">
                ...
                <div>
                    <div class="scrollbox"style="height:350px;overflow:auto;border:1px solid #aaa;padding:10px;">
                             @for($i = 1; $i < 81; $i++)
                                    <p><a href="{{url('/exam/learning?id='.$i,$i)}}" style="text-decoration: none ;color:black;">問{{$i}} コンテンツ<input type="checkbox"  name="check[]" style="margin-left:10px ;"></a></p>
                            @endfor
                    </div>
                </div>

                <div class="problem-btm" style="margin-top: 30px">
                    <a href='{{url('/exam/learning?id='.$Previous_btn,$Previous_btn)}}'><button>前の問題</button></a>
                    <a href='{{url('/exam/learning?id='.$Next_btn,$Next_btn)}}'><button>次の問題</button></a>
                </div>
            </div>
